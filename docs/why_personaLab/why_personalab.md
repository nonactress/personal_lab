...
| 제거된 수치 | 제거 이유 | 대체 |
|------------|-----------|------|
| "개발자는 실제 사용자보다 5~7배 빠르게 탐색" (NN/G 출처 주장) | 해당 NN/G 원문 없음, 출처 불명 | NN/G Novice vs Expert Users 개념으로 대체 |
| "40~60% 과소 예측" | 해당 연구 원문 없음 | — |
| "UX 테스트 수행률 < 20% (State of UX 리포트)" | 이 수치로 보고한 리포트 없음 | User Interviews 2024 (14% 전담 리서처 없음)으로 대체 |
| "Forrester ROI = 100:1" | 유료 리포트, 원문 접근 불가 | Gilb (1988) 1:10:100 법칙으로 대체 |
